<?php
    ...
    ?>
        ...
        <span style="margin-left:10px">Tema: <a class="tema" href="<?php echo base_url();?>index.php/plantillas/mostrar?listaPlantillas[]=<?php echo $fila->tema; ?>"><?php echo $fila->tema; ?></a></span><br>
