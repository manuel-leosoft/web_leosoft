           ...
           // alert(params);
            ...
            $.ajax({ 
                ...
                success: function(html){
                    ...
                    //setTimeout(function(){$("#numero_plantillas").html('&nbsp;').css("display","none")},5000);//borramos el mensaje en 5s
                }
            });
        }
    }
</script>
 <div style="display:none;" id="numero_plantillas">10</div>
 <span class="plantilla">Seleccione el tema de su plantilla:</span>
		<FORM id="formulario_plantillas" style="padding-top:30px;"  ACTION="plantilla2.php" METHOD="GET">
			...
			<tr>
				...
				<td>
                                <input onclick="prueba(this.id);" type="checkbox" id="fotografia" name="listaPlantillas[]" value="fotografia" </input>
			...
			<tr>
				...
				<td>
                                <input type="checkbox" id="ciencia" name="listaPlantillas[]" value="ciencia" </input>
                                <label for="ciencia"><span><span class="letra_azul">C</span>iencia</span></label>
                                <!--<input type=checkbox name=word >Ciencia-->
                                </td>

				<td>
                                <input type="checkbox" id="clubs_nocturnos" name="listaPlantillas[]" value="clubs_nocturnos" </input>
				...
				<td>
                                <input type="checkbox" id="coches" name="listaPlantillas[]" value="coches" </input>
                                <label for="coches"><span><span class="letra_azul">C</span>oches</span></label>
                                <!--<input type=checkbox name=presta >Coches-->
                                </td>
				
				<td>
                                <input type="checkbox" id="comida" name="listaPlantillas[]" value="comida" </input>
                                <label for="comida"><span><span class="letra_azul">C</span>omida</label>
                                <!--<input type=checkbox name=mage >Comida/bebida-->
                                </td>

				<td>
                                <input type="checkbox" id="comunicaciones" name="listaPlantillas[]" value="comunicaciones" </input>
			...
			<tr>
				...
				<td>
                                <input type="checkbox" id="deporte" name="listaPlantillas[]" value="deporte" </input>
                                <label for="deporte"><span><span class="letra_azul">D</span>eportes</span></label>
                                <!--<input type=checkbox name=power >Deporte-->
                                </td>

				<td>
                                <input type="checkbox" id="diseno" name="listaPlantillas[]" value="diseno" </input>
                                <label for="diseno"><span><span class="letra_azul">D</span>ise&ntilde;o</span></label>
                                <!--<input type=checkbox name=php >Diseño-->
                                </td>

				<td>
                                <input type="checkbox" id="diseno_exterior" name="listaPlantillas[]" value="diseno_exterior" </input>
				...
				<td>
                                <input type="checkbox" id="educacion" name="listaPlantillas[]" value="educacion" </input>
                                <label for="educacion"><span><span class="letra_azul">E</span>ducaci&oacute;n</span></label>
                                <!--<input type=checkbox name=flash >Educación-->
                                </td>

				<td>
                                <input type="checkbox" id="electronica" name="listaPlantillas[]" value="electronica" </input>
			...
			<tr>
				...
				<td>
                                <input type="checkbox" id="entretenimiento" name="listaPlantillas[]" value="entretenimiento" </input>
				...
				<td>
                                <input type="checkbox" id="familia" name="listaPlantillas[]" value="familia" </input>
                                <label for="familia"><span><span class="letra_azul">F</span>amilia</span></label>
                                <!--<input type=checkbox name=joom >Familia-->
                                </td>

				<td>
                                <input type="checkbox" id="flores" name="listaPlantillas[]" value="flores" </input>
                                <label for="flores"><span><span class="letra_azul">F</span>lores</span></label>
                                <!--<input type=checkbox name=presta >Flores-->
                                </td>
				
				<td>
                                <input type="checkbox" id="herramientas" name="listaPlantillas[]" value="herramientas" </input>
				...
				<td>
                                <input type="checkbox" id="hobbies" name="listaPlantillas[]" value="hobbies" </input>
			...
			<tr>
				...
				<td>
                                <input type="checkbox" id="hoteles" name="listaPlantillas[]" value="hoteles" </input>
                                <label for="hoteles"><span><span class="letra_azul">H</span>oteles</span></label>
                                <!--<input type=checkbox name=power >Hoteles-->
                                </td>

				<td>
                                <input type="checkbox" id="industria" name="listaPlantillas[]" value="industria" </input>
                                <label for="industria"><span><span class="letra_azul">I</span>ndustria</span></label>
                                <!--<input type=checkbox name=php >Industria-->
                                </td>

				<td>
                                <input type="checkbox" id="inmobiliaria" name="listaPlantillas[]" value="inmobiliaria" </input>
				...
				<td>
                                <input type="checkbox" id="interior" name="listaPlantillas[]" value="interior" </input>
				...
				<td>
                                <input type="checkbox" id="internet" name="listaPlantillas[]" value="internet" </input>
			...
			<tr>
				...
				<td>
                                <input type="checkbox" id="juegos" name="listaPlantillas[]" value="juegos" </input>
                                <label for="juegos"><span><span class="letra_azul">J</span>uegos</span></label>
                                <!--<input type=checkbox name=word >Juegos-->
                                </td>

				<td>
                                <input type="checkbox" id="leyes" name="listaPlantillas[]" value="leyes" </input>
				...
				<td>
                                <input type="checkbox" id="libros" name="listaPlantillas[]" value="libros" </input>
                                <label for="libros"><span><span class="letra_azul">L</span>ibros</span></label>
                                <!--<input type=checkbox name=presta >Libros-->
                                </td>
				
				<td>
                                <input type="checkbox" id="medicina" name="listaPlantillas[]" value="medicina" </input>
                                <label for="medicina"><span><span class="letra_azul">M</span>edicina</span></label>
                                <!--<input type=checkbox name=mage >Medicina-->
                                </td>

				<td>
                                <input type="checkbox" id="medio_ambiente" name="listaPlantillas[]" value="medio_ambiente" </input>
			...
			<tr>
				...
				<td>
                                <input type="checkbox" id="personales" name="listaPlantillas[]" value="personales" </input>
			...
			<tr>
				...
				<td>
                                <input type="checkbox" id="regalos" name="listaPlantillas[]" value="regalos" </input>
                                <label for="regalos"><span><span class="letra_azul">R</span>egalos</span></label>
                                <!--<input type=checkbox name=mage >Regalos-->
                                </td>

				<td>
                                <input type="checkbox" id="servicios_mantenimiento" name="listaPlantillas[]" value="servicios_mantenimiento" </input>
