...
class CI_Email {
	...
	var	$smtp_host		= "mail.ileosoft.com";		// SMTP Server.  Example: mail.earthlink.net
	var	$smtp_user		= "manuelgomez@ileosoft.com";		// SMTP Username
	var	$smtp_pass		= "6364483mj";		// SMTP Password
